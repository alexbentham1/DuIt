...
<p>Use the form below to contact Alex Bentham, the site's primary Administrator. He will email you your username and password.</p>
...
Unique User ID:
<input name="unique_user_id" type="text" value=""/>&nbsp;&nbsp;<br />
...
$subject = "Request for Administrator Login Details.";
$message = "I've forgotten my details. Please can you email them to me.<br />
			First Name = &nbsp;".$firstname."<br />
			Surname = &nbsp;".$surname."<br />
			Unique User ID = &nbsp;".$unique_user_id."<br />
			Email = &nbsp;".$sender."<br /><br />
			Thank you!";
