...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Users (`First Name`, Surname, `User ID`, Username, Password, email) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['First_Name'], "text"),
                       GetSQLValueString($_POST['Surname'], "text"),
                       GetSQLValueString($_POST['User_ID'], "int"),
                       GetSQLValueString($_POST['Username'], "text"),
  ...
  $insertSQL = sprintf("INSERT INTO Skills (`User ID`) VALUES (%s)",
  ...
  $insertSQL = sprintf("INSERT INTO tbl_mybooks (`picture_id`) VALUES (%s)",
