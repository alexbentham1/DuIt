...
mysql_select_db($database_MAMP, $MAMP);
$query_Recordset1 = "SELECT * FROM Skills";
...
if (isset($_POST['search'])){
	...
	$query = mysql_query("SELECT * FROM Skills WHERE Skill1 LIKE '%$searchq%'") or die("Could not search");
	...
	if ($count == 0){
		...
		while($row = mysql_fetch_array($query)) {
										...
										$Skill1 = $row ['Skill1'];
										$UserID = "User ID = &nbsp;" .$row ['User ID']. '</b>';
										$user_email = $row ['email'];					
										$output .= '<div> Expert: ' .$Username. '&nbsp;&nbsp;&nbsp;' .$UserID. '</div>';
...
<h7>Struggling? Ask an expert!<br /></h7>
<h2>Search for students who are 'Experts' in your tricky area. <br />
Then send them an email asking for help.<br /><br /></h2>
...
<table border="0">
  <tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;</td>
    <td><b>Expert Area</b></td>
    
  </tr>
  <?php do { ?>
    <tr>
    <td><img src="getImageStock.php?ID=<?php echo $row_Recordset1['User ID']; ?>" width="40" height="40" alt="IMAGE" /></td>
      <td>&nbsp;</td>
      <td><?php echo $row_Recordset1['User ID']; ?></td>
      <td>&nbsp;</td>
      ...
      <td>&nbsp;&nbsp;&nbsp;</td>
      <td>&nbsp;&nbsp;&nbsp;</td>
      <td><?php echo $row_Recordset1['Skill1']; ?></td>
      <td width="80px">
      <td><a href="mailto:<?php echo $row_Recordset1['email']; ?>?Subject=Help%20Me!" target="_top">Email</a></td>
    </tr>
...
<h2>If you have any issues with the DuIt site, or wish to change any of your personal details such as name or email address, please contact the site administrator using the form below.<br /></h2>
...
<form action="help.php" method="post" name="contact_form">

First Name:
<input name="First_name" type="text" value="<?php echo $row_Active_User['First Name']; ?>"/>&nbsp;&nbsp;

Username
<input name="Username" type="text" value="<?php echo $row_Active_User['Username']; ?>"/>&nbsp;&nbsp;
