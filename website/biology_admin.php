...
mysql_select_db($database_MAMP, $MAMP);
$query_Recordset1 = "SELECT * FROM biology ORDER BY Post_ID DESC";
...
$delete_record = "DELETE FROM biology WHERE Post_ID = {$ID}";

mysql_query($delete_record) or die(mysql_error());
	
header("location: biology_admin.php");
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO biology (`Time`, Post_ID, Username, User_ID, Post) VALUES (%s, %s, %s, %s, %s)",
...
<table border="0">
  <?php do { ?>
    ...
    <td><img src="getImageStock.php?ID=<?php echo $row_Recordset1['User_ID']; ?>" width="40" height="40" alt="IMAGE" /></td>
      ...
      <td>
      <a href=biology_admin.php?ID=<?php echo $row_Recordset1['Post_ID']; ?>>Delete</a>
