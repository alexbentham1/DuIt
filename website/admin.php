...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Main_Messages (`Time`, `Post ID`, Username, `User ID`, `First Name`, Surname, Post) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<a href="accounting_admin.php">Accounting</a><br />
<a href="art_admin.php">Art </a><br />
<a href="biology_admin.php">Biology </a><br />
<a href="business_studies_admin.php">Business Studies </a><br />
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td><input type="hidden" name="User_ID" value="<?php echo $row_Active_User['ID']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td><input type="hidden" name="First_Name" value="<?php echo $row_Active_User['First Name']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td><input type="hidden" name="Surname" value="<?php echo $row_Active_User['Surname']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
...
<table align="center">
  ...
  <tr>
  	<td width="100px"><?php echo $row_Messages['Time']; ?></td>
    <td>&nbsp;</td>
    <td width="100px"><?php echo $row_Messages['First Name']; ?>&nbsp;<?php echo $row_Messages['Surname']; ?></td>
    <td>&nbsp;</td>
    <td width="600px"><?php echo $row_Messages['Post']; ?></td>
    <td>&nbsp;</td>
    <td><a href=main_messages_delete.php?ID=<?php echo $row_Messages['Post ID']; ?>>Delete</a></td>
  </tr>
