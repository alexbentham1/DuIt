...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO art (`Time`, Post_ID, Username, User_ID, Post) VALUES (%s, %s, %s, %s, %s)",
...
$Active_User = mysql_query($query_Active_User, $MAMP) or die(mysql_error());
$row_Active_User = mysql_fetch_assoc($Active_User);
$totalRows_Active_User = mysql_num_rows($Active_User);$colname_Active_User = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_Active_User = $_SESSION['MM_Username'];
}
mysql_select_db($database_MAMP, $MAMP);
...
mysql_select_db($database_MAMP, $MAMP);
$query_Recordset1 = "SELECT * FROM art ORDER BY Post_ID DESC";
...
$delete_record = "DELETE FROM art WHERE Post_ID = {$ID}";
...
<table border="0">
  <?php do { ?>
    ...
    <td><img src="getImageStock.php?ID=<?php echo $row_Recordset1['User_ID']; ?>" width="40" height="40" alt="IMAGE" /></td>
      ...
      <td>
      <a href=art_admin.php?ID=<?php echo $row_Recordset1['Post_ID']; ?>>Delete</a>
