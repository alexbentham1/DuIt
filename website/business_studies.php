...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "business_studies.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
header("location: business_studies.php");
...
<title>DuIt - Business Studies</title>
...
<table border="0">
  <?php do { ?>
    ...
    <td><img src="getImageStock.php?ID=<?php echo $row_Recordset1['User_ID']; ?>" width="40" height="40" alt="IMAGE" /></td>
	  ...
	  if(Post==A_user)
	  {
		document.write("<a href=business_studies.php?ID=<?php echo $row_Recordset1['Post_ID']; ?>>Delete</a>");
	  }
